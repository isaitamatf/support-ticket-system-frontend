...
import { RANDOM_CLIENTS, RANDOM_DEADLINES, RANDOM_ISSUES, RANDOM_STATUS } from "../../constants";
...
export const BodyComponent: React.FC<BodyComponentProps> = ({tickets, updateTicket, createTicket}) => {
